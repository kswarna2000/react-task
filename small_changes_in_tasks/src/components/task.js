            ...
            <section id="cd-timeline" className="cd-container">
                <div className="cd-timeline-block">
                    ...
                    <div className="cd-timeline-content">
                        ...
                        <p>
                           <i> There are 3 stages in this task.<br />
                           ...
                           <b>** The upload button would show up at 4pm on September 13th. All the best **</b><br /></i>
                         </p>
                ...
                <div className="cd-timeline-block">
                    ...
                    <div className="cd-timeline-content">
                        ...
                        <p>
                           <i> There are 4 stages in this task.<br />
                            ...
                            3. NODE JS with mysql: <a target='_blank' href='https://medium.com/@avanthikameenakshi/building-restful-api-with-nodejs-and-mysql-in-10-min-ff740043d4be'>click here</a><br /></i>
...
<i>
                            ...
                            <b>** The upload button would show up at 4pm on October 8th. All the best **</b><br /></i>
                        </p>
                        {/*{this.state.task.indexOf(1) > -1 ?   <Alert color="success">*/}
                        {/*Submitted !! :) will get back soon*/}
                        {/*</Alert> : ''}*/}
